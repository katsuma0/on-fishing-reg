...
CSS="""
:root{--bg:#201D17;--wall:#2A261E;--card:#0E0D0B;--ink:#EDE6D6;--mute:#A79F8C;--line:rgba(237,230,214,.16);--line2:rgba(237,230,214,.08);--spot:#E01F26}
...
if __name__=="__main__":
    os.makedirs(os.path.join(OUT,"toyota_cal"),exist_ok=True)
    for i,c in enumerate(CARS_T):
        mn,fw,dd=MONTHS[i]
    ...
    print("wrote toyota calendar + 12 pages + spread", W, H)
