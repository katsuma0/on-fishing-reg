...
TOYO_GEOM.update({
 ...
 "rav4": dict(nose_x=52,tail_x=950,belly=268,nose_y=214,tail_y=206,hood_y=194,
    cowl_x=352,roof_fy=106,roof_ry=112,roof_fx=448,roof_rx=752,deck_x=890,deck_y=200,
    fwx=254,rwx=758,wr=84,belt=170),
 ...
 "fjcruiser": dict(nose_x=58,tail_x=944,belly=262,nose_y=204,tail_y=190,hood_y=192,
    cowl_x=352,roof_fy=98,roof_ry=100,roof_fx=440,roof_rx=758,deck_x=886,deck_y=194,
    fwx=256,rwx=750,wr=88,belt=162,white_roof=True),
})
